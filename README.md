...
Cards auto-register when the integration loads. Add them to your Lovelace dashboard.
...
| [Progress Card](#progress-card) | Kids | Track progress toward each reward |
...
Visual progress toward each reward goal. Great for keeping kids motivated.

```yaml
type: custom:choremander-progress-card
child_entity: sensor.emma_points
overview_entity: sensor.choremander_overview
```
